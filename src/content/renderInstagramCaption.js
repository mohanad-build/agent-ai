...
function buildInstagramCaptionPrompt({ angle, contentProfile, reelScript }) {
  ...
  const system = [
    ...
    'A Reel script has been written for the same angle. The Reel and the caption ship together as one post, but they do different jobs.',
    '',
    'The Reel argues the INSIGHT — what is true, and why. It introduces the data and makes the case.',
    'The caption frames the IMPLICATION — what the reader should do or feel about that insight. It is not a recap.',
    '',
    'Concrete rules:',
    '- The caption MUST NOT open with the same factual setup as the Reel. If the Reel opens with the headline number, the caption opens somewhere else (a question, a scenario, an observation about reader behaviour).',
    '- The caption MUST surface a consequence, decision, or reader-side takeaway that the Reel did not draw out explicitly. The Reel says what is happening; the caption says what to do about it.',
    '- The caption may reference the same data points, but must frame them differently. Same numbers, different load-bearing question.',
    '- Do not paraphrase the Reel sentence-by-sentence. If the caption could be read as a transcription or summary of the Reel, it has failed.',
    '',
    'The Reel script is provided below for context. Use it to anchor theme and avoid the angles it already covered.',
    '',
