...
const TABLE = {
  ...
  seller_sale: {
    states: ['preparing', 'live', 'suspended', 'conditional', 'firm', 'closed', 'terminated', 'collapsed'],
    initial: ['preparing', 'live'],
    terminal: ['closed', 'terminated', 'collapsed'],
    edges: [
      ['preparing', 'live'],
      ['live', 'conditional'],
      ['conditional', 'firm'],
  ...
  landlord_lease: {
    states: ['preparing', 'live', 'suspended', 'tenant_selected', 'signed', 'possession', 'closed', 'terminated', 'collapsed'],
    initial: ['preparing', 'live'],
    terminal: ['closed', 'terminated', 'collapsed'],
    edges: [
      ['preparing', 'live'],
      ['live', 'tenant_selected'],
      ['tenant_selected', 'signed'],
      ['signed', 'possession'],
      ['possession', 'closed'],
      ['live', 'suspended'],
      ['suspended', 'live'],
      ['tenant_selected', 'live'],
      ['signed', 'live'],
      ['preparing', 'terminated'],
      ['live', 'terminated'],
      ['possession', 'collapsed'],
